...
# Title: punto2_lab_comu
# Author: JohnLlamas2161740_NicolasSuarez2150313
...
class Labcomu_d1a_g06(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "punto2_lab_comu")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto2_lab_comu")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Labcomu_d1a_g06")
...
def main(top_block_cls=Labcomu_d1a_g06, options=None):
